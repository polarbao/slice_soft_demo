...
- Current task: `13C-01 TIFF-native TiffLayerSource and LRU`; 13B production acceptance remains blocked by unresolved device buildVolume/origin/axes and a 22-instance performance budget.
