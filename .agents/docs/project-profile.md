...
- Current task: TIFF T-A-01..03 are complete. Preserve SPI v1/11 exports/15 capabilities, Worker file contract, `p0.rgbwsv.2`, S2 path D and ViewData contracts. T-A-04 is blocked on external target RIP/control-software PackBits evidence; T-A-05 waits for one LibTIFF stabilization cycle; T-A-06 is deferred until a new algorithm is requested.
