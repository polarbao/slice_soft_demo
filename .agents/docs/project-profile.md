...
- Current phase: `03E-01` is complete and `03E-02` is internally complete; PackBits is an explicit experimental production option while default compression remains `none`. External target RIP interoperability is pending. `12E-09D-01..06` and `12E-10A` are complete. `12E-10B` is next.
