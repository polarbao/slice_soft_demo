...
- Current task: `13C-03 Unified Production Preview READY`; the task-specific UI wiring, async generation, coordinate mapping, two-entry navigation, smoke, and non-goal contracts are complete. 13C-01 manifest-authoritative TIFF source and 13C-02 no-Qt RGBWSV material composer are complete. 13B production acceptance remains blocked by unresolved device buildVolume/origin/axes and a 22-instance performance budget.
