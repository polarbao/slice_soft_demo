...
- Current phase: `03D-01..04` are complete; `03D-05` LibTIFF equivalence/bad-package/shared-Package work is READY. `12E-09D` remains the next prepared material-control specialty after 03D.
- Latest completed milestone: `03D-04 LibTIFF tiled Writer and stable failure model`
...
- Current task: `03D-01..04` are COMPLETE. The next 03D candidate is `03D-05`, covering exact decoded equivalence, required tags, strict/bad-package Reader cases, Legacy/Global/scene packages, and atomic publication. `12E-09D-01..06` follow 03D; `12E-10A` and `13F-R1-01..05` remain separately prepared. 13B production acceptance remains blocked by unresolved device buildVolume/origin/axes and a 22-instance performance budget.
