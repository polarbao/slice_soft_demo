...
16: ACTIVE / PARTIAL GO on 2026-08-12. 16A-01..05, 16B-01/02 and 16C-01 are complete. Sampling candidates and contact leveling remain disabled/diagnostic-only. The 16A-05 machine-readable matrix covers synthetic fixtures, Reality 5/5, Stage 15 and Package/RIP; 16A-06, 16B-03 and 16C-02 are dependency-ready, while 16D must still wait for 16A-06 and any approved 16B candidate.
```
