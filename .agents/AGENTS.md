...
15: ACTIVE on 2026-08-04. 15A-01..04, 15B-01..03, and 15D-01/02/04 are complete; G1/G2/G4/G5 pass. 15D-03 is PARTIAL because Quick CI stops at the support-bridge schema assertion, while golden hashes remain stable. Scope is Legacy full-volume RGB only: same-layer W carrier output for unprintable texture white, never S/V or ownership changes. The strict RGB Profile and Global behavior remain unchanged. The candidate Profile stays disabled/diagnostic until G7.
```
