...
- Stage 13 P0 PRD/DEV/DEMO and all 17 near-term task preparations are complete. `13A-01..05`, `13B-01..07`, `13C-01/02`, and scene-aware `12E-09A-02` are implemented and verified. 13C-01 provides a manifest-authoritative RGBWSV TIFF source, default 5-layer/256 MiB LRU, stable errors, cancellation/stale guards, and an asynchronous Qt worker. 13C-02 provides a no-Qt deterministic R/G/B/W/S/V, RGB combination, all-material, statistics, and six-channel probe composer without changing production TIFF or replacing the current panels. Stage 13 near-term implementation is now 14/17. `13C-03` Unified Production Preview has a task-specific PREP/PROMPT and is READY. 13B production remains `INPUT_OPEN` because device buildVolume/origin/axes and the 22-instance production budget are unresolved. 13C-03 must precede 12E-09A-05, then 12E-10 remains the single-model dual-engine closure.
