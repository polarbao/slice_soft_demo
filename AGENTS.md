...
- `12E-09D-01..06` are complete as of 2026-08-03: stable contracts, production texture settings, atomic single-material W/V resolution, conditional Qt controls, one-click Effective Config evidence, explicit Global `all_texture`, and the Release/RIP matrix all pass. `12E-10A` is also complete: production TIFF, 09A Texture/Fill semantics, W/S/V and exact `p0.material_closure.1` evidence are bound by real layerIndex/zMm. `12E-10B` is next.
