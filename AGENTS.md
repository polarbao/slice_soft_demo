...
- Stage 15 is active as of 2026-08-04. `15A-01..04`, `15B-01..03`, and `15D-01/02/04` are complete; automatic Gates G1/G2/G4/G5 pass. `15D-03` is partial because Quick CI currently stops at the support-bridge schema assertion, while baseline golden hashes remain unchanged. The scope remains Legacy full-volume RGB same-layer W carrier output only; do not change `p0.rgbwsv.2`, closure rules, Writer/TIFF, S/V, ownership, the existing strict RGB Profile, or Global Surface Shell behavior. The candidate Profile remains `enabled=false` and `productionSafety=diagnostic` until physical Gate G7.
