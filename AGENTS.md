...
- `03D-01..03` are complete as of 2026-07-31: the handwritten contract/Release baseline, optional LibTIFF 4.7.1 build and Runtime lane, Writer interface, handwritten adapter, and LibTIFF stripped Writer are executable. `03D-04` is READY for tiled/error-model work. The default backend remains handwritten and must not switch without the documented GO gate and explicit authorization.
