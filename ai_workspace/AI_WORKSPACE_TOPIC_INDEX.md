...
当前上下文：`context_handoff/2026-07-27_13A-04完成与13A-05准备.md`
...
实现代码已开始，Stage 13 近程任务完成 5/17，跨阶段前置 09A-02 已完成；
13A=模型俯视和实例变换；
