...
> 文档状态：**ACTIVE — H-D-01..05 完成 / H-E-02 完成，H-E-06 READY**（H-D-06 等待人工证据）
...
| **H-E-06** | E3 | **纹理白区预检接入**：对照主干 `TextureWhitePreflightService`（Stage 15 15C 成果）| H-E-05 | 导入/切片前给出保守告警；结果携带 scene/revision/contentHash，切换场景后旧结果丢弃（Stage 15 坑 7）| **PREPARED / READY（在 H-E-02 后）** |
