...
> 文档状态：**ACTIVE — H-D-01..05 完成 / H-E E2 完成，E3 READY**（H-D-06 等待人工证据）
...
| **H-E-02** | E3 | **批量导入**：多选文件一次导入并逐个 `addInstance`；对照主干 `SceneBatchImportController` | H-E-01 | 单次原子 Commit 或明确的逐项失败语义；**部分失败不得留半个场景** | **PREPARED / READY** |
