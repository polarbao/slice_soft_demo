...
> 文档状态：**ACTIVE — H-D-01..05 完成 / H-E-01..06 完成 / E3_GATE=PASS**（H-D-06 等待人工证据）
...
| **H-D-06** | **端到端人工可操作性验收**：按 §4 口径逐步走通七步流程并归档截图；把「显示」维度回填 `REPORT_HOSTFLOW_H_C_03` | H-D-01..05 | 七步全部人工可完成；A/B 对照新增「显示」维度差异条目 | **PREPARED / WAIT HUMAN EVIDENCE**（代码前置已完成）|
