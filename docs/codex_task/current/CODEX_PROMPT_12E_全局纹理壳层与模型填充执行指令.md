...
> 文档状态：12E-08D COMPLETE / GENERIC ENTRY / 09B USE DEDICATED PROMPT
> 日期：2026-07-20
> 状态刷新：2026-07-23
> 当前生产主线使用 `CODEX_PROMPT_12E_09B_Qt双模式生产入口执行指令.md`
...
```text
只执行用户明确指定的一个 Task 12E-XX；12E-08D-01..06 已完成，不得重复执行或重写其生产边界；
