...
两材质 Z 范围几乎完全重叠并共享同一顶面；
【v2.1 更正】此前据 Z 重叠推断的“绿色开放面包裹浅桃色闭合主体”已被逐面实测推翻：
03.obj 是薄壳，两材质分别贴在壳的相对两面，不存在包裹关系；建模 +Z 面 82.4% 浅桃色、
-Z 面 100% 绿色，生产链固定施加 rotate_x_180_rotate_z_minus_90 摆正后顶面才 100% 全绿，
这才是顶面投影全绿的真正原因；绿色面到浅桃色面最小间距 0.3008 mm；
