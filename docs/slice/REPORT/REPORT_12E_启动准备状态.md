...
12E：R0 complete，12E-01..07 与 12E-08A/08B/08C complete；12E-08C-R1/R2/R3 complete，R3-04 NO-GO；R4-01..03 COMPLETE，R4-04 READY，Release budget blocked，12E-08D blocked。
```
...
| 12E-08C-R4 | IN PROGRESS / R4-01..03 COMPLETE / R4-04 READY | 模型预检、模式准入、正常模型正向链与修复资产准入；R4-04 等待明确启动，R4-06 后依赖外部资产 |
...
12E-08C-R4：IN PROGRESS，R4-01..03 COMPLETE，R4-04 READY；
...
12E-08A/08B/08C 与 R1/R2/R3、R4-01/02/03 已完成。下一任务为已准备就绪的 R4-04 Qt Preflight UI；12E-08
...
post-strict 审计后才能重跑 Release Gate。R4-01..03 COMPLETE，R4-04 READY，12E-08D 继续 BLOCKED。
