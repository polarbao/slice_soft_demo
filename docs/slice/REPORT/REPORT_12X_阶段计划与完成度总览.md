...
> 当前下一任务：13B-07 真实模型矩阵与收口 PREPARATION
...
| Stage 13 | P0 ATOMIC PREP COMPLETE / 13A-01..05、13B-01..06、13B-04A、跨阶段 09A-02 COMPLETE | 实例变换、场景配置、诊断身份、多模型纹理 +Z 俯视、精确变换、镜像、独立准入、1..22 实例列表、11x2规则排版、fixture 幅面碰撞、共享 Raster/联合内存层、单 package/scene report 和 M13-1 候选闭环 | 补齐并执行 13B-07 功能矩阵；外部输入继续阻断 production |
...
| Stage 13 | P0 需求/设计/验证/原子准备 COMPLETE / 13A-01..05、13B-01..06、13B-04A COMPLETE | 13B-07 PREPARATION；13C-03 必须先于 09A-05 |
