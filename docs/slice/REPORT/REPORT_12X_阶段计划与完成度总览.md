...
| 03D-LIBTIFF | 03D-01..05 COMPLETE / 03D-06 READY | 手写基线、可选 LibTIFF 依赖/Runtime、stripped/tiled、稳定错误、像素/tag、严格坏包和共享 Package Gate 已闭环 | 03D-06/07 未实现；默认 Writer 未切换 |
...
| 03D-LIBTIFF | 03D-01..05 COMPLETE / 03D-06 READY | 执行 Release Writer-only 性能矩阵与 GO/NO-GO 判定 |
...
```text
1. 03D-01..05 已完成；03D-06..07 为第一优先级，03D-06 已准备；
