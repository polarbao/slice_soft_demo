...
> 当前下一任务：13A-04 镜像与变换后预检 READY；13A-01..03、13B-01、scene-aware 12E-09A-02 已完成
...
| Stage 13 | P0 ATOMIC PREP COMPLETE / 13A-01..03、13B-01、跨阶段 09A-02 COMPLETE | 实例变换、场景配置、诊断身份、+Z 俯视工作区、精确变换和 session 保存闭环 | 执行 13A-04 镜像与变换后预检；外部输入按 Gate 阻断 production |
...
| Stage 13 | P0 需求/设计/验证/原子准备 COMPLETE / 13A-01..03、13B-01 COMPLETE | 当前执行 13A-04；13C-03 必须先于 09A-05 |
...
13B-01..07 共 7 个；
13C-01..05 共 5 个；
合计 17 个，当前代码完成数为 4；跨阶段前置 12E-09A-02 已另行完成。
```
...
Stage 13 已完成 13A-01..03/13B-01，单模型显示与精确变换已实现；镜像后准入、排版、联合切片和
TIFF 原生预览仍未实现。
```
