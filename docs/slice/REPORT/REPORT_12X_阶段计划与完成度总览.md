...
> 当前下一任务：13A-05 阶段收口 READY；13A-01..04、13B-01、scene-aware 12E-09A-02 已完成
...
| Stage 13 | P0 ATOMIC PREP COMPLETE / 13A-01..04、13B-01、跨阶段 09A-02 COMPLETE | 实例变换、场景配置、诊断身份、+Z 俯视、精确变换、镜像和变换后独立准入闭环 | 执行 13A-05 阶段收口；外部输入按 Gate 阻断 production |
...
| Stage 13 | P0 需求/设计/验证/原子准备 COMPLETE / 13A-01..04、13B-01 COMPLETE | 当前执行 13A-05；13C-03 必须先于 09A-05 |
...
Stage 13 已完成 13A-01..04/13B-01，单模型显示、精确变换、镜像和变换后准入已实现；阶段收口、
排版、联合切片和 TIFF 原生预览仍未实现。
```
...
13A-05：READY，当前下一任务，只做阶段证据和回归收口；
