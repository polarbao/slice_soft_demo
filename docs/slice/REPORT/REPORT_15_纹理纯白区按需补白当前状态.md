...
> 阶段：Stage 15 ｜ 状态：**ACTIVE / EXTERNAL GATE** ｜ 版本：v1.8 ｜ 更新：2026-08-04
...
| 15E | 交付收口 | 🟡 15E-01/03 完成；15E-02 被 G7 阻断 |
...
| G7 | **实物打样确认** | ⬜ ← 唯一非自动化门 |
| G8 | 注册表翻转与文档同步 | 🟡 文档同步完成；注册表翻转被 G7 阻断 |
...
2. `15E-02`：只能在 G7 通过后启用候选 Profile；当前不得执行。
