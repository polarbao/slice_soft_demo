...
证明生产铺底新增 N 个模型下方物理层，最大支撑投影只作用于新增前 N 层；
...
| G13-05 | prepend base enabled, N=30 | TIFF 总层数 +30，0..29 为铺底，模型首层后移到 30 |
| G13-05B | overlay_existing, N=30 | 历史 TIFF 总层数保持不变 |
...
layerPlacement / addedLayerCount / modelLiftMm；
