...
> 文档状态：PARTIAL / R1-01 CONTRACT + R1-02 ELIGIBILITY IMPLEMENTED
...
policy，现有 serializer 可输出 decisions。尚未实现 generated fixture golden、实际 repair、文件写入、post-strict
或 production admission。
