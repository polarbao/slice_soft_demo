...
| `DOC_DECISION_12E_08C_R4_07_开发准入放宽规则.md` | R4-07 Development Gate 与最终 required-family Gate 分离决策 |
| `DOC_PREP_12E_08C_R4_07_FourCaseReleaseGate准备.md` | R4-07 开发/最终双 Gate、四 case Release/global/legacy 守门准备 |
| `DOC_EXEC_12E_08C_R4_07_DevelopmentGate结果.md` | development intake 2/2、四 case 4/4 与 legacy TIFF/RIP 结果 |
| `assets/DIAGRAM_12E_R4_模型拓扑问题示意图.svg` | R4 strict 阻断问题类型与诊断边界示意 |
...
| `DOC_PREP_13C_03_UnifiedProductionPreview准备.md` | 13C-03 TIFF 原生生产预览、异步切层、两级入口和探针接线合同 |
...
| `DOC_DECISION_16_切片几何采样甲片接触姿态与性能专项.md` | Stage 16 采样/姿态/性能专项立项、候选和 Stage 14 后准入决策；当前未激活 |
