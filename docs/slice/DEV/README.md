...
本目录存放正式技术方案和阶段执行设计，用于回答“怎么做、模块边界在哪里、如何验证”。

## 当前入口

| 文件 | 用途 |
|---|---|
| `DEV_FORMAL_SliceSoft_正式切片软件总体技术方案.md` | 正式切片软件总体技术方案 |
| `DEV_DEMO_IMPLEMENTED_SliceSoft_当前Demo技术基线.md` | 当前 demo 已实现技术基线 |
| `DEV_SHORT_MID_LONG_SliceSoft_项目运行计划执行方案.md` | 短期 / 中期 / 长期项目运行计划执行方案 |
