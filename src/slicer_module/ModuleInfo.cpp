...
constexpr std::string_view ModuleInfoJson{
    ...
    R"json(","provides":["model.import","model.get_metadata","model.release","scene.apply_operation","scene.get_snapshot","scene.get_viewdata","geometry.preflight","geometry.collision","geometry.repair","slice.rgbwsv","slice.rgbwsvt","package.verify","package.get_summary","package.get_layer_descriptor","package.render_layer_preview","package.read_report"],"produces":[{"contract":"p0.rgbwsv.2","kind":"package"},{"contract":"p0.rgbwsvt.1","kind":"package"}],"capabilities":{"maxConcurrentJobs":1,"cancelLatencyMs":2000,"syncCapabilities":["model.import","model.get_metadata","model.release","scene.apply_operation","scene.get_snapshot","scene.get_viewdata","geometry.preflight","geometry.collision","package.verify","package.get_summary","package.get_layer_descriptor","package.render_layer_preview","package.read_report"],"workerCapabilities":["geometry.preflight","geometry.repair","slice.rgbwsv","slice.rgbwsvt"]}})json"};
